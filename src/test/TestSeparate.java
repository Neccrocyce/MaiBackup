...
public class TestSeparate {
    ...
    public static void setup () {
        MaiLogger.setUp(MaiBackup.getInstance(), -1, -1, true, "Z:/logs");
    ...
    public void testCopy () {
        ...
        callMethod2("copy", Paths.get("Z:/Backup/src/01/a.txt"), Paths.get("Z:/Backup/dst/01/e.txt"), Paths.get("Z:/Backup/dst/02/g.txt"));
    ...
    public void testConnectDisconnect () {
        ...
        try {
            callMethod("loadSettings");
            callMethod("connectDrive");
            assert(new File ("X:").exists());
            Thread.sleep(2000);
            callMethod("disconnectDrive");
    ...
    //TODO: test Override and deleted
    @Test
